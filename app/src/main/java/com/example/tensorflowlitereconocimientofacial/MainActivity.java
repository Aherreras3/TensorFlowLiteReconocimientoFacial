package com.example.tensorflowlitereconocimientofacial;
...
import com.example.tensorflowlitereconocimientofacial.ml.PerrosReconoce;
...
public class  MainActivity extends AppCompatActivity
   ...
   /* Intent intent = new Intent(MediaStore.ACTION_IMAGE_CAPTURE);
    ...
    public void PersonalizedModel(View v) {
        try {
            PerrosReconoce model = PerrosReconoce.newInstance(getApplicationContext());
            TensorImage image = TensorImage.fromBitmap(mSelectedImage);

            PerrosReconoce.Outputs outputs = model.process(image);
